layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider','jquery','form'], function() {
    ...
    table.render({
        ...
        ,title: '错误信息表'
        ,cols: [[ //表头
            {field: 'sortNo', title: '申请退返时间'}
            ,{field: 'sortNo', title: '运单号码'}
            ,{field: 'num', title: '参考编号'}
            ,{field: 'orderNum', title: '处理状态'}
            ,{field: 'errorInfo', title: '退返类型'}
            ,{field: 'errorInfo', title: '退返备注'}
            ,{field: 'errorInfo', title: '处理意见'}
            ,{field: 'errorInfo', title: '退返方式'}
            ,{field: 'errorInfo', title: '退返单号'}
            ,{field: 'errorInfo', title: '操作人'}
            ,{field: 'errorInfo', title: '退返时间'}
            ,{field: 'errorInfo', title: '寄件网点'}
            ,{field: 'errorInfo', title: '客户名称'}
